 ...
 * PublishedData
 *
 * @ORM\Table(name="published_data")
 * @ORM\Entity(repositoryClass="NK\PersoPageBundle\Repository\PublishedDataRepository")
 */
class PublishedData
{
    /**
...
/**
    ...
    /**
     * @ORM\OneToOne(targetEntity="NK\PersoPageBundle\Entity\Professor", inversedBy="publishedData")
